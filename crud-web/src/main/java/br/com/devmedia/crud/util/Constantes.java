...
/**
 * Classe de constantes universais para o sistema
 * 
 * @author Devmedia
 * 
 */
public class Constantes {
	...
	public static final String CONEXAO_BD_PROPERTIES = "br.com.devmedia.crud.util.config_bd";
	
	public static final String CONEXAO_BD_DRIVER = "conexao.driver.mysql";
